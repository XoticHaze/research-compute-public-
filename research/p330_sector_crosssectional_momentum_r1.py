...
for _,r in z.iterrows():
    cur=set(r['top']); overlap=len(prev & cur) if prev else 0; turnover=1.0 if not prev else 1.0-overlap/TOP_K
    net.append(r['gross']-turnover*COST_BPS/10000); turns.append(turnover); prev=cur
