...
def term_spread():
 ...
 if len(s)!=13114 or s.index.max()!=pd.Timestamp('2026-09-04',tz='UTC'): raise RuntimeError(f'pinned T10Y2Y identity/coverage mismatch rows={len(s)} last={s.index.max()}')
