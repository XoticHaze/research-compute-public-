...
EXPECTED_BY_REVISION = {
    ...
    "20260912-r4": set(EXPECTED_STATE_BY_ID) - {"YAHOO_EPS_SURPRISE_SIGN_R1", "PIT_INSIDER_OPEN_MARKET_PURCHASE_R1", "VIX_CURVE_FUND_STRESS_GATE_R1", "P546_SLOOS_CREDIT_STANDARDS_R1"},
    "20260912-r5": set(EXPECTED_STATE_BY_ID) - {"PIT_INSIDER_OPEN_MARKET_PURCHASE_R1", "VIX_CURVE_FUND_STRESS_GATE_R1", "P546_SLOOS_CREDIT_STANDARDS_R1"},
    "20260912-r6": set(EXPECTED_STATE_BY_ID) - {"VIX_CURVE_FUND_STRESS_GATE_R1", "P546_SLOOS_CREDIT_STANDARDS_R1"},
    "20260913-r7": set(EXPECTED_STATE_BY_ID) - {"P546_SLOOS_CREDIT_STANDARDS_R1"},
    "20260913-r8": set(EXPECTED_STATE_BY_ID),
}
