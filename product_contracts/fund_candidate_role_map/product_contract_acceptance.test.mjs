...
const operatorLabels=['Residual alpha persists; simple risk gate rejected','SEPARATE QUESTIONS','Residual alpha is not universal scarce-capital dominance.']
...
test('operator rendering states the distinction explicitly',()=>assert.deepEqual(operatorLabels.length,3))
