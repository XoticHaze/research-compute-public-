...
const MM_HEAD = 'd96c1ae58b2dcd863d0647e0d0c965fd3e4cc2f1'
...
test('P57 acceptance binds the exact MM corrected operator-product head',()=>assert.equal(MM_HEAD,'d96c1ae58b2dcd863d0647e0d0c965fd3e4cc2f1'))
