...
const MM_HEAD='d9b1a878f49d838595daa1bac13342f28681eaed'
...
test('P52 acceptance binds exact current MM product head and source/result identity',()=>{
  assert.equal(MM_HEAD,'d9b1a878f49d838595daa1bac13342f28681eaed')
